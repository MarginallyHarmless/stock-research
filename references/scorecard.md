# Scorecard — praguri și raționament

Rostul acestui fișier e ca aceeași companie să primească aceleași culori indiferent de zi și de starea de spirit a modelului. Fără praguri scrise, evaluarea alunecă spre „îmi place compania asta" și raportul își pierde valoarea.

Pragurile nu sunt legi. Când o companie e clar la limită, spune asta în text („🟡, dar aproape de verde — datoria scade rapid") în loc să forțezi o culoare.

**Cuprins**
1. [Moat](#1-moat)
2. [Free cash flow](#2-free-cash-flow)
3. [Cash vs. datorii](#3-cash-vs-datorii)
4. [Buyback vs. diluție](#4-buyback-vs-diluție)
...
Evaluează pe rând cele cinci surse clasice de avantaj și spune la fiecare dacă există, nu doar dă un verdict global. Ordinea de mai jos e de la cel mai durabil la cel mai fragil — asta contează, pentru că un începător tinde să supraevalueze brandul și să subevalueze costurile de schimbare.

| Tip de moat | Întrebarea care îl testează | Cât e de durabil |
|---|---|---|
| **Costuri de schimbare** (switching costs) | Dacă un client ar vrea să plece mâine la un concurent, cât l-ar durea? Trebuie să remigreze date, să reinstruiască tot personalul, să rescrie integrări? | Cel mai durabil |
| **Efect de rețea** (network effect) | Produsul devine mai valoros pentru fiecare utilizator pe măsură ce se adaugă alții? | Foarte durabil, dar rar autentic |
| **Avantaj de cost / scară** | Poate produce mai ieftin decât oricine, structural — nu doar temporar? | Durabil în industrii mature |
| **Active intangibile** | Brevete, licențe, aprobări de reglementare, monopol legal de facto | Durabil cât ține protecția |
| **Brand** | Oamenii plătesc mai mult pentru același produs doar pentru siglă? | Cel mai fragil — se erodează |

**Semafor:**
- 🟢 — cel puțin un moat clar din primele trei categorii, susținut de dovezi în cifre: marjă brută stabilă sau în creștere de peste 3 ani, ROIC peste ~15%, cotă de piață care nu se erodează.
- 🟡 — moat plauzibil dar dependent de execuție sau de un singur produs; sau moat real într-o industrie care se schimbă rapid.
- 🔴 — produs de comoditate, clienții pleacă la orice diferență de preț, marja brută în scădere, sau moat-ul se sprijină doar pe brand într-o categorie unde brandul nu mai contează.

**Dovada în cifre contează mai mult decât povestea.** Orice companie susține în raportul anual că are avantaje competitive. Marja brută e testul: dacă poate ține prețuri mari ani la rând fără să piardă clienți, moat-ul e real. Dacă marja brută scade constant, moat-ul crapă indiferent ce scrie în prezentări.

---

## 2. Free cash flow

- 🟢 — pozitiv în cel puțin 4 din ultimii 5 ani **și** cu tendință de creștere; marja FCF (FCF / venituri) peste ~10%.
- 🟡 — pozitiv dar volatil sau plat; marjă FCF 0–10%; sau negativ într-un an din cauza unei investiții mari explicabile (o fabrică, o achiziție).
- 🔴 — negativ în ultimul an fără explicație clară, sau negativ în majoritatea ultimilor 5 ani.

**Nuanțe:**
- O companie tânără în creștere rapidă poate avea FCF negativ pentru că investește agresiv. Nu e automat roșu — dar atunci întrebarea devine *de unde vin banii*: din cash-ul existent (acceptabil), din datorie nouă (risc), sau din emisiune de acțiuni noi (te diluează).
- **Compară FCF cu profitul net.** Dacă profitul e mare ani la rând dar FCF-ul e mult mai mic, banii se blochează undeva — stocuri, creanțe neîncasate, capex mare. Merită menționat.
- La companii cu stock-based compensation mare (tech), FCF-ul raportat e umflat, pentru că plata în acțiuni nu iese ca numerar dar te costă prin diluție. Menționează dacă SBC depășește ~10% din venituri.

---

## 3. Cash vs. datorii

Calculează **datoria netă = datorie totală − cash și investiții pe termen scurt**.

- 🟢 — poziție de *net cash* (mai mult cash decât datorii), **sau** datorie netă / EBITDA sub 1,5x.
- 🟡 — datorie netă / EBITDA între 1,5x și 3x.
- 🔴 — peste 3x, **sau** rata de acoperire a dobânzii (EBIT / cheltuieli cu dobânzile) sub 3x, **sau** scadențe mari în următoarele 12 luni fără cash care să le acopere.

**De ce contează pragul de 3x:** o companie cu datorie mică poate traversa o recesiune sau o creștere de dobânzi fără să vândă active pe nimic sau să emită acțiuni noi la preț prost. Una îndatorată e forțată să ia decizii proaste la momentul cel mai prost. Cele mai multe falimente nu vin din lipsă de profit, ci din lipsă de cash la o scadență.

**Excepții importante:** băncile și companiile financiare funcționează structural pe datorie — raportul nu se aplică. Utilitățile și imobiliarele (REIT) suportă normal 4–6x pentru că au venituri foarte previzibile. Spune asta explicit în loc să dai roșu automat.

---

## 4. Buyback vs. diluție

**Semaforul se pune pe evoluția numărului de acțiuni, nu pe suma cheltuită cu răscumpărări.** Asta e distincția cea mai importantă din întreaga grilă.

- 🟢 — numărul de acțiuni în circulație a scăzut consistent în ultimii 3 ani (peste ~1%/an).
- 🟡 — numărul e aproximativ plat (±1%/an), inclusiv cazul în care compania cheltuie mult pe buyback dar doar compensează acțiunile date angajaților.
- 🔴 — numărul crește peste ~2%/an, sau compania emite acțiuni noi ca să se finanțeze.

**Verificări suplimentare care nuanțează culoarea:**
- **Răscumpără cu bani sau cu datorie?** Buyback finanțat din FCF e sănătos. Buyback finanțat din împrumuturi înseamnă că schimbă siguranța bilanțului pe un preț mai bun al acțiunii pe termen scurt.
- **Răscumpără scump?** O companie care a cumpărat masiv la maxime istorice și a oprit când prețul a căzut a distrus valoare. Compară anii cu buyback mare cu evoluția prețului.

**Prezintă randamentul total pentru acționar, nu doar buyback-ul.** Adună randamentul dividendului cu randamentul răscumpărărilor (suma cheltuită pe buyback împărțită la capitalizare) și spune cifra combinată: „compania îți returnează în total ~4,5% pe an, din care 1,5% dividend și 3% răscumpărări". Un începător compară instinctiv doar dividendele între companii și concluzionează că o firmă fără dividend nu-i dă nimic — ceea ce e fals dacă răscumpără agresiv. Cele două sunt economic aproape echivalente; diferența practică e că dividendul se impozitează în anul în care îl primești, iar buyback-ul abia când vinzi.

Verifică și dacă dividendul e acoperit din free cash flow. Dacă plata dividendelor depășește FCF-ul mai mulți ani la rând, e finanțat din datorie sau din rezerve și nu va dura.

---

## 5. Creștere și marje

- 🟢 — venituri în creștere în 4 din 5 ani **și** marjă brută stabilă sau în urcare.
...
Nu există un P/E „corect" universal. Compară întotdeauna pe trei axe și spune care e concluzia din fiecare:

1. **Față de propria istorie** — multiplul actual vs. media pe 5 ani a companiei.
...
### Ce presupune prețul actual

Partea care transformă evaluarea din cifră în înțelegere. Un multiplu nu e o etichetă de „scump" sau „ieftin" — e o afirmație despre viitor pe care piața a făcut-o deja, iar tu pariezi împotriva ei sau alături de ea.
...
Un multiplu izolat nu spune nimic. Pune un tabel scurt cu 2-3 competitori direcți pe aceleași câteva rânduri — P/E, P/FCF, marjă brută, creșterea veniturilor, datorie netă/EBITDA. Devine imediat vizibil dacă acțiunea e scumpă pentru sectorul ei sau dacă tot sectorul e evaluat așa. Alege competitori reali, din aceeași nișă, nu doar companii mari din același sector.

---

## 7. Sentiment de piață
...
Raportul intrări/ieșiri de pe MarketBeat e mai informativ decât procentul de deținere. Peste 60% deținere instituțională e situația normală la orice companie americană mare — nu spune nimic. Direcția banilor spune.

**Short interest — explică mecanismul, nu doar cifra.** Cine vinde în lipsă (short) împrumută acțiuni, le vinde, și speră să le răscumpere mai ieftin. Un short interest mare înseamnă că mulți profesioniști pariază pe scădere. Un începător aude „short squeeze" și îl citește ca pe o oportunitate; în realitate e mult mai des un avertisment că cineva mai bine informat vede o problemă. Squeeze-ul e un eveniment rar și imprevizibil, nu o strategie.

**Days to cover** (short ratio) e mai util decât procentul brut: arată câte zile de tranzacționare normală ar dura ca toți cei pe short să iasă. Peste 5 zile înseamnă potențial de mișcări violente în ambele direcții.

**Includerea într-un indice** (S&P 500, Nasdaq-100) aduce cumpărare automată din partea fondurilor pasive care replică indicele — o cerere constantă care nu ține de rezultatele companiei. Excluderea funcționează invers.

**Consensul analiștilor** (`Target Price` și `Recom` de pe finviz) merită menționat, dar însoțit de context, altfel face mai mult rău decât bine. Trei lucruri de spus o dată:
...
| Tip | Ce se schimbă |
|---|---|
| **Bănci / financiare** | Datoria e materie primă, nu risc. Folosește raportul de capital și ROE, nu datorie/EBITDA. FCF e aproape lipsit de sens. |
| **REIT / imobiliare** | Îndatorare mare e normală. Folosește FFO (funds from operations) în locul FCF, și dividendul e obligatoriu prin lege. |
...
Multe companii au clase multiple de acțiuni cu drepturi de vot diferite. Acțiunile vândute publicului au adesea un vot pe acțiune, sau niciunul, în timp ce fondatorii dețin o clasă cu zece voturi. Rezultatul e că poți deține 5% din capital și să nu ai practic niciun cuvânt de spus: fondatorul păstrează controlul chiar dacă ajunge la o fracțiune din companie.

Nu e automat un lucru rău — controlul fondatorului poate proteja strategia pe termen lung de presiunea trimestrială a pieței. Dar e un lucru de știut înainte, nu după: dacă managementul ia decizii proaste, acționarii minoritari nu au cum să le schimbe.
