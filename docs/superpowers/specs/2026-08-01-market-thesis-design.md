...
- **Ce cifră de cash intră în pistă** — cea mai recentă cifră **depusă la SEC** (10-K, 10-Q sau 8-K), cu documentul și data spuse în raport; cash-ul restricționat se scade. Cifrele dintr-o prezentare pentru investitori sau dintr-un comunicat nedepus nu contează. Criteriul e „depus", nu „bilanț": o companie ridică bani între bilanțuri, iar dacă ignori runda pentru că n-a ajuns încă într-un 10-Q, descrii o finanțare care nu mai există. Numitorul e arderea medie pe patru trimestre; când arderea accelerează prin plan, se spune că pista reală e mai scurtă, dar cifra nu se ajustează, iar la limita de patru trimestre se arată ambele variante. Fără regula asta, aceleași fetch-uri dădeau șase „de fază" sau zero, după cum alegea cititorul.
